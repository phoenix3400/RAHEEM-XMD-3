...
`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/s8px1j.jpg` },
                caption: dec,
                contextInfo: {
...
╰──────────────┈⊷`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/dj9mbh.jpg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ RAHEEM CM*`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/5a8qp5.jpg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ RAHEEM CM*`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/dllyv8.jpg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ RAHEEM-CM*`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/jepene.jpg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ RAHEEM CM*`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/qrg4cq.jpg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ RAHEEM CM*`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/x24scg.jpg` },
                caption: dec,
                contextInfo: {
                    mentionedJid: [m.sender],
                    forwardingScore: 999,
